    ...
    render(){
        ...
        return(
                <Form
                    ...
                    <Row style={{float: "right", marginBottom: -10, marginRight: 0, width: 1000}} align="middle">
                        ...
                        <Link to="/mainmap">
                                <Button type="Primary" size="medium" ghost={true} style={{marginLeft: 1, marginTop: 26}} onClick={this.onLogin}>Log in</Button>
                        </Link>
                        </div>
                    </Row>
                </Form>
